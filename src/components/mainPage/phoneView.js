    ...
    <div className="rootPhone justify-content-center">
      ...
      {assetLoading === false && (
        <div className="row main ">
          <div
            className="ChatBox d-flex justify-content-center row"
            onClick={() => hideMenu()}
          >
            {openChat === false && (
              <div className="listRoom d-flex align-items-center col-12">
                <div className="left">
                  <button className="newChatBtn">
                    <span
                      onClick={() => showContact(true)}
                      className="span1 border-end border-dark"
                    >
                      <img
            ...
            {openChat === true && (
              <div className="chatView col-12">
                <div className="contactView d-flex justify-content-between border-bottom border-2">
                  <div
                    onClick={() => showContactProfil()}
                    className="avatarAndName d-flex justify-content-start align-items-center col-11"
                  >
                    <div
                      className="closeChat"
                    ...
                    {roomId.destinationName !== "" && (
                      <p className="">{roomId.destinationName}</p>
                    )}
                    {roomId.destinationName === "" && (
                      <p className="">{roomId.destination}</p>
                    )}
                  </div>
          ...
          <div className="col-2 openProfil d-none">
            {contactProfil === true && <ContactProfil />}
            {contactProfil === false && <Profil />}
          </div>
        </div>
      )}
      {openDelChat === true && (
